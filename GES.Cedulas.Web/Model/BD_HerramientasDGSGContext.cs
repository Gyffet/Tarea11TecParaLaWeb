...
{
    public partial class BD_HerramientasDGSGContext : DbContext
    {
        public BD_HerramientasDGSGContext()
        {
        }

        public BD_HerramientasDGSGContext(DbContextOptions<BD_HerramientasDGSGContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EvaluacionMensajeria>(entity =>
            {
                ...
                entity.Property(e => e.fcPenaAcuses).HasColumnType("money");

                entity.Property(e => e.fcPenaEntrega).HasColumnType("money");

                entity.Property(e => e.fcPenaEstado).HasColumnType("money");

                entity.Property(e => e.fcPenaExtravio).HasColumnType("money");

                entity.Property(e => e.fcPenaMaterial).HasColumnType("money");

                entity.Property(e => e.fcPenaRecoleccion).HasColumnType("money");
