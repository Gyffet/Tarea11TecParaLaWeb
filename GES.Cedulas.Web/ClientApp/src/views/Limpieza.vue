        ...
        <v-row class="text-center">
            <v-col class="mb-4">
                <h1 class="display-1 font-weight-bold mb-3"
                    align="center">
                    Cédula Automatizada para la Supervisión y Evaluación del Servicio de Limpieza en Áreas Comunes y Oficinas
                </h1>
            </v-col>
        </v-row>
        ...
        <div v-if="opcionesServer.selectMes!=null && mesVacio == true">
            ...
            <v-row>
                <v-col class="title row" align="left">
                    1. ¿El personal de limpieza cumplió con las actividades contempladas en el programa de operación?
                </v-col>
            </v-row>
            <v-row>
                <v-radio-group v-model="datosCed.boolActividades"
                               row>
                    <v-radio label="Sí"
                             value="true"></v-radio>
                    <v-radio label="No"
            ...
            <div v-if="datosCed.boolActividades=='false'">
                <v-row align="center" justify="space-around">

                    <template>
                        <div class="text-center">
                            <v-dialog v-model="dialogProgramaOP"
                                      width="1000">
                                ...
                                <v-card>
                                    ...
                                    <v-card-text>
                                        Si tiene duda de la respuesta consulte el Programa de Operación
                                        <v-row align="center">
                                            <v-col cols="12"
                                                   md="4">

                                                <span class="block text-gray-600 text-sm text-left font-bold mb-2">Fecha de la incidencia:</span>
                                                <vc-date-picker v-model="objetoManual.fechaIncidencia"
                                                                required
                                                                :mask="masks"
                                        ...
                                        <v-row>
                                            <v-col cols="12"
                                                   md="4">
                                                <v-select id="tipoIncidencia"
                                                          v-model="objetoManual.tipoIncidencia"
                                                          :items="incidenciaTipo"
                                                          :error-messages="validTipoInci"
                                                          @input="$v.objetoManual.tipoIncidencia.$touch()"
                                                          @blur="$v.objetoManual.tipoIncidencia.$touch()"
                                            ...
                                            <v-col cols="12"
                                                   md="4">
                                                <v-select id="areaIncidencia"
                                                          v-model="objetoManual.areaIncidencia"
                                                          :items="tipoInci(objetoManual.tipoIncidencia)"
                                                          :error-messages="validAreaInci"
                                                          :disabled="objetoManual.tipoIncidencia != null ? false : true"
                                                          @input="$v.objetoManual.areaIncidencia.$touch()"
                                                          @blur="$v.objetoManual.areaIncidencia.$touch()"
                                                          label="Área"
                                                          dense
                                                          outlined></v-select>
                                            </v-col>
                                            ...
                                            <v-col cols="12"
                                                   md="12">
                                                <v-text-field v-model="objetoManual.comentarios"
                                                              :counter="300"
                                                              :error-messages="validComentInci"
                                                              @input="$v.objetoManual.comentarios.$touch()"
                                                              @blur="$v.objetoManual.comentarios.$touch()"
                                                              label="Comentarios"
                                    ...
                                    <v-card-actions>
                                        ...
                                        <v-btn color="primary"
                                               text
                                               @click="dialogProgramaOP = false">
                                            Cerrar
                                        </v-btn>
                                        <v-btn color="primary"
                                               text
                                               @click="agregarIncPO(objetoManual)">
                                            Agregar
                                        </v-btn>
                                    </v-card-actions>
                                </v-card>
                    ...
                    <div>
                        <template>
                            <div class="text-center">
                                <v-dialog v-model="dialogRegisPO"
                                          width="1000">
                                    <template v-slot:activator="{ on, attrs }">
                                        <v-btn color="teal darken-1"
                                               dark
                                            ...
                                            <v-row align="center">
                                                <v-col align="center">
                                                    <table class="table table-sm table-hover">
                                                        ...
                                                        <tbody>
                                                            <tr v-for="(item,index) in datosCed.arregloActividades" :key="item.tipoIncidencia">
                                                                <th>{{item.fechaIncidenciaFormat}}</th>
                                                                <th> | </th>
                                                                <th>{{item.tipoIncidencia}}</th>
                                                                <th> | </th>
                                                                <th>{{item.areaIncidencia}}</th>
                                                                <th> | </th>
                                                                <th>{{item.comentarios}}</th>
                                                                <th> | </th>
                                                                <v-icon class="mr-2"
                                                                        color="red"
                                                                        @click="eliminarPO(index)">
                                                                    mdi-delete-empty
                                                                </v-icon>
                                                                <th> | </th>
                                                                <v-icon class="mr-2"
                                                                        color="blue"
                                                                        @click="editarInciPOp(index)">
                                                                    mdi-pencil
                                                                </v-icon>
                                                            </tr>
                                                        </tbody>
                    ...
                    <div v-if="dialogEditarPO==true">
                        <template>
                            <div class="text-center">
                                <v-dialog v-model="dialogEditarPO"
                                          width="1000">
                                    ...
                                    <v-card>
                                        ...
                                        <v-card-actions>
                                            ...
                                            <v-btn color="primary"
                                                   text
                                                   @click="dialogEditarPO = false">
                                                Cancelar
                                            </v-btn>
                                            <v-btn color="primary"
                                                   text
                                                   @click="editarPO(objetoManual)">
                                                Editar
                                            </v-btn>
                                        </v-card-actions>
                                    </v-card>
            ...
            <v-row>
                <v-col class="title row" align="left">
                    2. ¿El personal del servicio de limpieza portó uniforme e identificación en todo momento?
                </v-col>
            </v-row>
            <v-row>
                <v-col class="title row" align="left">
                    <v-radio-group v-model="datosCed.boolUniforme"
                                   row>
                        <v-radio label="Sí"
                                 value="true"></v-radio>
                        <v-radio label="No"
            ...
            <v-row>
                <v-col>
                    <v-row class="title row">
                        3. ¿Hubo disponibilidad de equipo y maquinaria para la operación del servicio en el periodo?
                    </v-row>
                    <v-row class="subtitle-1 row">
                        El prestador estar obligado a tener siempre disponible los materiales necesarios para la operación de su servicio
                    </v-row>
                </v-col>
            </v-row>

            <v-row>
                <v-radio-group v-model="datosCed.boolEquipo"
                               row>
                    <v-radio label="Sí"
                             value="true"></v-radio>
                    <v-radio label="No"
            ...
            <div v-if="datosCed.boolEquipo=='false'">
                <v-row align="center" justify="space-around">
                    <template>
                        <div class="text-center">
                            <v-dialog v-model="dialogEquipo"
                                      width="1000">
                                <template v-slot:activator="{ on, attrs }">
                                    <v-btn color="teal darken-1"
                                           dark
            ...
            <v-row>
                <v-col>
                    <v-row class="title row">
                        4. ¿Hubo inasistencias del personal de limpieza en el periodo?
                    </v-row>
                </v-col>
            </v-row>
            <v-row>
            ...
            <v-row align="center">
                <v-col>
                    ...
                    <v-row class="title row">
                        6-1. ¿Fué entregado el comprobante de pago y las constancias de inscripción al IMSS (SUA)?
                    </v-row>
                    <v-row class="subtitle-1 row">
                ...
                <v-col>
                    <v-row class="title row">
                        6-2. ¿Se entregó el Acta Entrega-Recepción de los servicios mensual?
                    </v-row>
                    <v-row>
            ...
            <div v-if="primerMes==true">
                <v-row align="center">
                    <v-col>
                        ...
                        <v-row>
                            <span class="block text-gray-600 text-sm text-left font-bold mb-2">Fecha de la visita</span>
                        </v-row>

                        <v-row>
                            <v-col>
                                <v-radio-group v-model="entregables.boolVisita"
                                               column>
                                    <v-radio label="Sí"
                                             value="true"></v-radio>
                                    <v-radio label="No"
                            ...
                            <v-col>
                                <div v-if="entregables.boolVisita=='true'">


                                    <span class="block text-gray-600 text-sm text-left font-bold mb-2">Fecha de la Visita</span>
                                    <vc-date-picker v-model="entregables.fechaVisita"
                                                    required
                                                    :mask="masks"
                                                    :locale="{firstDayOfWeek: 1}"
                                                    :disabled-dates='{ weekdays: [1, 7] }'
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            editarEquipo(index) {
                console.log(this.datosCed.arregloEquipo[index]);
                this.objetoEquipo = { ...this.datosCed.arregloEquipo[index] }
                console.log(this.objetoEquipo);
                this.index = index;
                this.dialogRegEquipo = false;
            ...
            agregarEquipo(objeto) {
                if (this.$v.objetoEquipo.$invalid) {
                    ...
                    this.datosCed.arregloEquipo.push(copia);

                    this.objetoEquipo.fechaIncidencia = null;
                    this.objetoEquipo.maquinaria = null;
                    this.objetoEquipo.comentarios = null;
            ...
            editarPO(objeto) {
                this.datosCed.arregloActividades.splice(this.index, 1);
                this.agregarIncPO(objeto);
            },

            editarInciPOp(index) {
                console.log(this.datosCed.arregloActividades[index]);
                this.objetoManual = { ...this.datosCed.arregloActividades[index] }
                console.log(this.objetoManual);
                this.index = index;
                this.dialogProgramaOP = false;
                this.dialogEditarPO = true;
            },

            eliminarPO(item) {
                console.log(item);
                var arreglo = this.datosCed.arregloActividades;
                var result = confirm("¿Eliminar registro?");
                if (result == true) {
                    console.log("se elimina ", arreglo[item]);
                    arreglo.splice(item, 1);
