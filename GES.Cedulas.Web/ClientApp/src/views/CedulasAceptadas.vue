<template>
    <v-container>
        <h1>Cédulas Aceptadas</h1>
        <v-row>
            <v-col>
                <h3>Estas son las cédulas que se aceptaron, puede imprimir el reporte para firmas:</h3>
                <br />
                ...
                <table class="table table-sm table-hover">
                    ...
                    <tbody>
                        <tr v-for="item in cedulas.fumigacion" :key="item.pkPenalizacion">
                            <th>{{item.fcMes}}</th>
                            <th> | </th>
                            <th>{{item.fcInmueble}}</th>
                            <th> | </th>
                            ...
                            <v-icon class="mr-2"
                                    color="red"
                                    @click="goToFumigacion(item.fcNoCed)">
                                mdi-file-eye
                            </v-icon>
                        </tr>
                    </tbody>
...
<script>
    ...
    export default {
        ...
        mounted() {
            CedulasService.getAceptadas().then(
                m => {
                    this.cedulas = m;
